...
export default function NoticiasPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12">
      <h1 className="text-4xl text-terracota-escuro">Notícias e Eventos</h1>
      ...
      <section className="mt-8" aria-labelledby="eventos">
        <h2 id="eventos" className="text-2xl text-marrom">
          Próximos eventos
        </h2>
      ...
      <section className="mt-12" aria-labelledby="mural">
        <h2 id="mural" className="text-2xl text-marrom">
          Mural de notícias
        </h2>
        <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {avisos.map((noticia) => (
